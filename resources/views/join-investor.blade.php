            ...
            <div id="smooth-content" class="mil-content">
                ...
                <div class="mil-small-banner">
                    <div class="mil-image-frame">
                        <!-- banner image -->
                        <img src="img/content/5.jpg" alt="img" class="mil-scale-img" data-value-1=".5" data-value-2="1.2">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                ...
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="name" class="mil-link" type="text" required>
                            ...
                            <div class="col-lg-6">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="email" class="mil-link" type="email" required>
                            ...
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="number" class="mil-link" type="text" required>
                                    <label class="mil-link">Phone number*</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="linkedin" class="mil-link" type="text" required>
                                    <label class="mil-link">LinkedIn account</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <select name="where" class="mil-link" style="width: 100%; background: transparent; border: none; padding-left: 15px;" required>
										<option value="">Where you heared about us ?</option>
                                    ...
                                    <label class="mil-link"></label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="industries" class="mil-link" type="text" required>
                                    <label class="mil-link">What are industries do you invest in ?</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <select name="region" class="mil-link" style="width: 100%; background: transparent; border: none; padding-left: 15px;" required>
                            ...
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <select name="type" class="mil-link" style="width: 100%; background: transparent; border: none; padding-left: 15px;" required>
										<option value="Pre-seed funding">Pre-seed funding (idea)</option>
										<option value="Seed Funding">Seed Funding (MVP)</option>
										<option value="Later funding">Later funding</option>
                                    </select>
                                    <label class="mil-link"></label>
                                    <span></span>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="how_much" class="mil-link" type="text" required>
                                    <label class="mil-link">How much do you invest ?</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="how_many" class="mil-link" type="text" required>
                                    <label class="mil-link">How many investments do you make per year ?*</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <textarea name="note" class="mil-link" required></textarea>
                                    <label class="mil-link">Note</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <button class="mil-float-right mil-button mil-button-lg mil-scale-down-trigger mil-dark-trigger mil-mb-30"><span>JOIN</span></button>
