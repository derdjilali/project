                ...
                <div class="container mil-content-frame mil-appearance mil-p-120-90">
                    <div class="row justify-content-between mil-mb-90">
                        <div class="col-xl-5">
                            ...
                            <h3 class="mil-mb-60 mil-appearance">Join Us as Mentor</h3>
                                ...
                                <div class="col-lg-12">
                                    <div class="mil-icon-box mil-box-hori mil-appearance mil-mb-30">
                                        <div class="mil-icon-box-text">
                                            <h6>Train and support start-ups and innovative project leaders become part
                                                of our Startup accelerator</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="first_name" class="mil-link" type="text" required>
                                    <label class="mil-link">First Name</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="last_name" class="mil-link" type="text" required>
                                    <label class="mil-link">Last Name</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="zipcode" class="mil-link" type="text" required>
                                    <label class="mil-link">ZIP Code*</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="distance" class="mil-link" type="text" required>
                                    <label class="mil-link">Distance from Algeria Venture</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <select name="type" class="mil-link"
                                        style="width: 100%; background: transparent; border: none; padding-left: 15px;"
                                        required>
                                        <option value="Community-based">Community-based&nbsp;:
                                            Determine meeting times and locations based on
                                            preferences</option>
                                        <option value="Site-based">Site-based&nbsp;: Meet at a
                                            consistent time and place - i.e. school, workplace, etc.</option>
                                        <option value="E-mentoring">E-mentoring&nbsp;: Meet virtually
                                            through different platforms</option>
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <p class="mil-text-sm mil-mb-30">*We promise not to disclose your personal information
                                    to third parties.</p>
                            </div>
                            <div class="col-lg-6">

                                <button
                                    class="mil-float-right mil-button mil-button-lg mil-scale-down-trigger mil-dark-trigger mil-mb-30"><span>JOIN</span></button>
