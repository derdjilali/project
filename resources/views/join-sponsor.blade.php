                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="bus_name" class="mil-link" type="text" required>
                                    <label class="mil-link">Business Name</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="contact" class="mil-link" type="text" required>
                                    <label class="mil-link">Contact Name*</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="company" class="mil-link" type="text" required>
                                    <label class="mil-link">Company name</label>
                                    <span></span>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="level" class="mil-link" type="text" required>
                                    <label class="mil-link">Desired level of sponsorship</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <textarea name="comment" class="mil-link" required></textarea>
                                    <label class="mil-link">Comments (Questions, comments, requirements, etc) </label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
