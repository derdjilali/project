            ...
            <div id="smooth-content" class="mil-content">
                ...
                <div class="container mil-content-frame mil-appearance mil-p-120-90">
                    <div class="row justify-content-between">
                        <div class="col-lg-5">
                            <span class="mil-link mil-softened-60 mil-appearance mil-mb-30">Our News</span>
                            <h3 class="mil-appearance mil-mb-30">Learn About Our News </h3>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-lg-12">
                                    <p class="mil-first-letter mil-appearance mil-mb-30">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore assumenda
                                            ...
                                            provident ratione, culpa ex laudantium, enim sit ut eius.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container mil-content-frame mil-appearance mil-p-60-30" style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1;">
                    <div class="row">


                        <div class="col-lg-4">

                            <div class="mil-portfolio-item mil-appearance mil-mb-30" style="translate: none; rotate: none; scale: none; transform: translate(0px, 50px) scale(0.98, 0.98); opacity: 0;">
                                <a href="training-details.php?id=2232" class="mil-cover mil-square mil-scale-down-trigger">
                                    <div class="mil-image-frame">
                                        <img src="img/blog/large/9.jpg" alt="Project cover">
                                    </div>
                                </a>
                                <span class="mil-zoom-icon mil-hidden-trigger" style="z-index: 1000; background-color:#212742;" >
                                    <img src="logo.svg" alt="zoom">
                                </span>
                                <div class="txt">
                                    <p>
                                        Marketing
                                    ...
                                    <h5>
                                        5 step to create an Outstanding Marketing Plan
                                    </h5>
                                </div>
                                <div class="bgcolor">
