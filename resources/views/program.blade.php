    ...
    <div id="smooth-wrapper">
        ...
        <div id="swupMain" class="mil-main-transition">
            ...
            <div id="smooth-content" class="mil-content">
                ...
                <div class="mil-gray-bg mil-p-120-90">
                    <div class="container">
                        <div class="row justify-content-between">
                            <div class="col-xl-5">
                                <h3 class="mil-link mil-appearance mil-accent mil-mb-30">Algeria Venture</h3>
                                <h3 class="mil-mb-30 mil-appearance">Program</h3>
                            </div>
                        </div>
                        <div class="row">
                            @foreach ($programs as $program)
                                <div class="col-lg-4">
                                    <div class="mil-price-card mil-appearance mil-mb-30" style="height: 700px; ">
                                        <h5 class="mil-mb-15">{{ $program->title }}</h5>
                                        {{ $program->sub_title }}
                                        ...
                                        <a href="/applytoprogram"
                                            class="mil-button mil-button-lg mil-scale-down-trigger mil-buttons-space program_btn"><span>Apply
                                                now</span></a>
                                    </div>
                                </div>
                            @endforeach
