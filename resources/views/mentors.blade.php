            ...
            <div id="smooth-content" class="mil-content">
                ...
                <div class="container mil-content-frame mil-appearance mil-p-120-90">
                    <table class="table table-bordered">
                        ...
                        <thead>
                            <tr>
                                <th class="title" scope="col" colspan="7">List of certified mentors</th>
                            </tr>
                            <tr class="header">
                                <th scope="col">Sequential NO</th>
                                <th scope="col">Certafication NO</th>
                                <th scope="col">First Name</th>
                                <th scope="col">Last Name </th>
                                <th scope="col">Wilaya</th>
                                <th scope="col">Speciality</th>
                                <th scope="col">Download Technical Sheet</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <th scope="row">#122234</th>
                                <td>AVTR-GG DDG-324</td>
                                <td>USER  </td>
                                <td>USER</td>
                                <td>Algiers</td>
                                <td>Business Plan</td>
