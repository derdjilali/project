                ...
                <div class="container mil-content-frame mil-appearance mil-p-120-90">
                    <div class="row justify-content-between mil-mb-90">
                        <div class="col-xl-5">
                            ...
                            <h3 class="mil-mb-60 mil-appearance">Join Us as Partner</h3>
                    ...
                    <form action="{{route('partner.store')}}" method="POST">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="company_name" class="mil-link" type="text" required>
                            ...
                            <div class="col-lg-6">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="company_site" class="mil-link" type="text" required>
                                    <label class="mil-link">Company website</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="job" class="mil-link" type="text" required>
                                    <label class="mil-link">Job title</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <textarea name="desc" class="mil-link" required></textarea>
                                    <label class="mil-link">Describe more about how you see us partnering together</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
