                ...
                <div class="container mil-content-frame mil-appearance mil-p-120-90">
                    <div class="row justify-content-between mil-mb-90">
                        <div class="col-xl-5">
                            ...
                            <h3 class="mil-mb-60 mil-appearance">Need Support ?</h3>
                    ...
                    <form action="{{ route('support.store') }}" method="POST">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="msg" class="mil-link" type="text" required>
                                ...
                                <button
                                    class="mil-float-right mil-button mil-button-lg mil-scale-down-trigger mil-dark-trigger mil-mb-30"><span>SEND</span></button>
