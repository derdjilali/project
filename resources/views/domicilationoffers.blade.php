            ...
            <div id="smooth-content" class="mil-content">
                ...
                <div class="container mil-content-frame mil-appearance mil-p-120-90">
                    <div class="row justify-content-between">
                        <div class="col-lg-12">
                            <span class="mil-link mil-softened-60 mil-appearance mil-mb-30">Algeria Venture</span>
                            <h3 class="mil-appearance mil-mb-30">Domicilation Offers </h3>
                        </div>
                        <p>
                            ‼️Attention everyone!  <br>

                            We are excited to announce a fantastic opportunity to establish your startup or innovative project at
                           Algeria Venture - one of the most captivating hub in the country. <br>

                           We are dedicated to building the future builders and would love to assist you in your journey
                           towards success. <br>

                            For more information, please contact us at domiciliation@aventure.dz <br>

                           Please note that this offer is subject to certain conditions. <br>

                           #domiciliation #startup #success #future #opportunit
                        </p>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-between align-items-center mil-appearance">
                            <div class="col-md-6 col-xl-3 mil-mb-30">
                                ...
                                <a data-fancybox="gallery" data-no-swup href="img/content/12.jpg"
                                    ...
                                    <img src="{{ asset('img/dom1.jpeg') }}" alt="photo">
                                </a>
                            ...
                            <div class="col-md-6 col-xl-3 mil-mb-30">
                                ...
                                <a data-fancybox="gallery" data-no-swup href="img/content/12.jpg"
                                    class="mil-just-image mil-image-vert mil-icon-3-trigger">
                                    <img src="{{ asset('img/dom3.jpeg') }}" alt="photo">
                                </a>
                            ...
                            <div class="col-md-6 col-xl-3 mil-mb-30">
                                ...
                                <a data-fancybox="gallery" data-no-swup href="img/content/12.jpg"
                                    class="mil-just-image mil-image-vert mil-icon-3-trigger">
                                    <img src="{{ asset('img/dom2.jpeg') }}" alt="photo">
                                </a>
                ...
                <div class="mil-appearance container" style="padding-bottom: 60px">
                    <a href="{{route('domicilation.create')}}" class="mil-button mil-button-lg mil-scale-down-trigger mil-buttons-space"><span>
                            Apply Now</span></a>
