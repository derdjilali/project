    ...
    <div id="smooth-wrapper">
        ...
        <div id="swupMain" class="mil-main-transition">
            ...
            <div id="smooth-content" class="mil-content">
                ...
                <div class="container mil-content-frame mil-appearance mil-p-60-30"
                    style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1;">
                    <div class="row">
                        <div class="col-12 mil-text-center mil-appearance mil-mb-120"
                            style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1;">
                            <h3 class="mil-link mil-appearance mil-accent mil-mb-30"
                                style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1;">
                                Algeria Venture</h3>
                            <h3 class="mil-appearance mil-mb-30"
                                style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1;">
                                Our trainings programs</h3>
                            <p class="mil-text mil-appearance m-auto"
                                style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1;">
                                Incidunt rerum neque sint omnis est ipsam nam. Esse natus, officiis illo rem beatae, ut
                                iste quis iusto officia laudantium, sapiente veritatis.</p>
                        </div>

                        @foreach ($trainings as $training)


                        <div class="col-lg-4 tariningProgram">

                            <div class="mil-portfolio-item mil-appearance mil-mb-30"
                                style="translate: none; rotate: none; scale: none; transform: translate(0px, 50px) scale(0.98, 0.98); opacity: 0;">
                                <a href="/training-details/{{$training->id}}" class="mil-cover mil-square mil-scale-down-trigger">
                                    <div class="mil-image-frame">
                                        <img src="pictures/trainings/{{$training->cover_img}}" alt="Project cover">
                                    </div>

                                    <span class="mil-zoom-icon mil-hidden-trigger"
                                        style="z-index: 1000; background-color:#212742;">
                                        <img src="logo.svg" alt="zoom">
                                    </span>
                                    <div class="txt">
                                        <h6>
                                            {{$training->cover_title}}
                                        </h6>
                                        <h3>
                                            {{$training->title}}
                                        </h3>
