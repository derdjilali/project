        ...
        <div id="swupMain" class="mil-main-transition">
            ...
            <div id="smooth-content" class="mil-content">
                ...
                <div class="container mil-content-frame mil-appearance mil-p-120-120">
                    <div class="row justify-content-between training-info">
                        <div class="col-4 mil-mb-120">
                            Start On <br> <br> {{$training->start_on}}
                        </div>
                        <div class="col-4 mil-mb-120">
                            Diration <br> <br> {{$training->diration}}
                        </div>
                        <div class="col-4 mil-mb-120">
                            Location <br> <br> {{$training->location}}
                        </div>
                    </div>
                    <div class="row justify-content-between">
                        <div class="col-lg-6 mil-mb-120">
                            <span class="mil-link mil-appearance mil-mb-30">Algeria Venture</span>
                            <h3 class="mil-appearance mil-mb-30">{{$training->title}}</h3>
                        ...
                        <div class="col-lg-5">
                            <div class="tariningProgram">
                                ...
                                <div class="mil-portfolio-item mil-appearance mil-mb-30"
                                    ...
                                    <a href="/training-details" class="mil-cover mil-square mil-scale-down-trigger">
                                        <div class="mil-image-frame">
                                            <img src="logo.svg" alt="Project cover">
                                        </div>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-6 mil-mb-120">
                            <h5 class="">This program is for you if you want to ... </h5>
                            <p class="">
                                {{$training->goals}}
                            </p>
                            <br>
                            <h5 class="">Who is this program for </h5>
                            <p class="">
                        ...
                        <div class="col-lg-6 mil-mb-120">
                            <h5 class="">How you will learn </h5>
                            <p class="">
                                {{$training->how_learn}}
                            </p>
