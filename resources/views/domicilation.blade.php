                ...
                <div class="container mil-content-frame mil-appearance mil-p-120-90">
                    <div class="row justify-content-between mil-mb-90">
                        <div class="col-xl-5">
                            ...
                            <h3 class="mil-mb-60 mil-appearance">Domicilation </h3>

                        </div>

                    </div>
                    <form action="{{route('domicilation.store')}}" method="POST">
                        @csrf
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                ...
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    ...
                                    <label class="mil-link"> Full Name</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="wilaya" class="mil-link" type="text" required>
                                    <label class="mil-link">Wilaya:</label>
                                    <span></span>
                                </div>
                                <div class=" mil-appearance mil-hidden-trigger mil-mb-30">

                                    <label class="mil-link">Birthday :</label>
                                    <input name="birthday" class="mil-link" type="date" required>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="label" class="mil-link" type="text" required>
                                    <label class="mil-link">Are you have a label :</label>
                                    <span></span>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="idea" class="mil-link" type="text" required>
                                    <label class="mil-link">I d of label</label>
                                    <span></span>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mil-styled-input mil-appearance mil-hidden-trigger mil-mb-30">
                                    <input name="desc" class="mil-link" type="text" required>
                                    <label class="mil-link">Description</label>
                                    <span></span>
                                </div>
                            </div>
